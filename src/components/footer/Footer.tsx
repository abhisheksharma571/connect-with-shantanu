...
function Footer() {
  return (
    <div className='h-[260px] w-full bg-[#CA5C36] flex'>
    <div className='h-[200px] w-full bg-[#c2b3b3] flex justify-center items-center gap-5'>
      <div className='flex flex-col justify-center items-center'>
        <WordPullUp
          className="text-2xl font-bold tracking-[-0.02em] text-[#CA5C36] md:text-4xl md:leading-[5rem]"
        ...
        <div className='flex gap-6'>
          <a href="https://www.facebook.com/Datacracksolutions?mibextid=qi2Omg&rdid=ODd6bwd08uUzrY12&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2Fi4dBAwVuQaHCujKM%2F%3Fmibextid%3Dqi2Omg" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
            <FontAwesomeIcon icon={faFacebook} className="text-[#CA5C36] text-2xl rounded-full hover:text-blue-500" />
          </a>
          <a href="https://www.linkedin.com/company/analyticsbyshantanu/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
            <FontAwesomeIcon icon={faLinkedin} className="text-[#CA5C36] text-2xl rounded-full hover:text-blue-700" />
          </a>
          <a href="https://www.instagram.com/analyticsbyshantanu?igsh=MTd4azFyeXE4N3I1MA%3D%3D" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
            <FontAwesomeIcon icon={faInstagram} className="text-[#CA5C36] text-2xl rounded-full hover:text-pink-500" />
          </a>
        </div>
      </div>
    </div>
